    ...
    <template #content>
      <div class="Portfolio__content">
        ...
        <div class="Portfolio_image-container">
          <img loading="lazy" :src="image1" alt="living room" class="Portfolio__img">
        </div>
        <div class="Portfolio__description">
        ...
        <div class="Portfolio_image-container">
          <img loading="lazy" :src="image3" alt="living room" class="Portfolio__img">
        </div>
        <div class="Portfolio_image-container">
          <img loading="lazy" :src="image2" alt="kitchen" class="Portfolio__img">
        </div>
        <div class="Portfolio__description">
