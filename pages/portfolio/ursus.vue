<template>
    <PortfolioParallax image="/images/portfolio/ursus/ursus4.jpg" title="Ursus">
        ...
        <div class="Portfolio1__content">
            ...
            <div class="Portfolio1_image-container">
            <img :src="image4" alt="bathroom" class="Portfolio1__img">
            </div>
            <div class="Portfolio1_image-container" style="padding: 2.5rem 0;">
            <img :src="image5" alt="bathroom" class="Portfolio1__img">
            </div>
            <div class="Portfolio1_image-container">
            <img :src="image6" alt="bathroom" class="Portfolio1__img">
            </div>
            <div class="Portfolio1__description">
            ...
            <div class="Portfolio1_image-container">
            <img :src="image7" alt="bathroom" class="Portfolio1__img">
            </div>
            <div class="Portfolio1_image-container">
            <div class="Portfolio1__row">
                <img :src="image8" alt="bathroom" class="Portfolio1__img">
                <img :src="image9" alt="bathroom" class="Portfolio1__img">
            </div>
            </div>
        </div>
        </template>
